...
class QQWing(type: GameType, difficulty: GameDifficulty) {
    ...
    fun calculateDifficulty(): GameDifficulty {
    ...
    @Suppress("unused")
    fun printSolveInstructions() = print(getSolveInstructionsString())

    fun getSolveInstructionsString(): String = if (isSolved()) {
