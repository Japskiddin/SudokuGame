...
import io.github.japskiddin.sudoku.feature.game.ui.component.autosizetext.SuggestedFontSizesStatus.Companion.rememberSuggestedFontSizesStatus
import io.github.japskiddin.sudoku.feature.game.ui.component.autosizetext.SuggestedFontSizesStatus.VALID
  ...
  CompositionLocalProvider(
    ...
    BoxWithConstraints(
      ...
      val electedFontSize = kotlin.run {
        if (suggestedFontSizesStatus == VALID)
...
public fun <E> List<E>.findElectedValue(shouldMoveBackward: (E) -> Boolean): E = run {
...
public enum class SuggestedFontSizesStatus {
  VALID,
  INVALID,
  UNKNOWN;
...
@Composable
public fun PreviewAutoSizeTextWithMaxLinesSetToIntMaxValue() {
  MaterialTheme {
...
@Preview(widthDp = 60, heightDp = 30)
@Composable
public fun PreviewAutoSizeTextWithMinSizeSetTo14() {
  MaterialTheme {
...
@Preview(widthDp = 60, heightDp = 30)
@Composable
public fun PreviewAutoSizeTextWithMaxLinesSetToOne() {
  MaterialTheme {
...
@Composable
public fun PreviewAutoSizeTextWithMCharacter() {
  MaterialTheme {
...
@Preview(widthDp = 50, heightDp = 100)
@Composable
public fun PreviewAutoSizeTextWithYCharacter() {
  MaterialTheme {
    Surface(color = MaterialTheme.colorScheme.error) {
      AutoSizeText(
        text = "y",
